...
void BackgroundSubtractorLOBSTER::apply(cv::InputArray image, cv::OutputArray fgmask, double learningRate){
	BackgroundSubtractorLOBSTER::operator()(image,fgmask,learningRate);
}
...
void BackgroundSubtractorLOBSTER::operator()(cv::InputArray _image, cv::OutputArray _fgmask, double learningRate) {
	...
	/* TR START Parameterize post-processing */
