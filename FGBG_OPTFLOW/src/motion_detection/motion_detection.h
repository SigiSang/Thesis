...
// class MdKde : public MotionDetection{
// public:
// 	MdKde(Mat& firstFr){ init(firstFr); }
// 	~MdKde(){ destroy(); }
...
// void MdKde::next(Mat& nxtFr, Mat& motionMask, bool applyPostProcessing){
// 	Mat backgroundModel;
//     kde.process(nxtFr,motionMask,backgroundModel);
// }
...
// class MdPawcs : public MotionDetection{
// public:
// 	MdPawcs(){  }
// 	MdPawcs(Mat& firstFr){ init(firstFr); }
// 	~MdPawcs(){ destroy(); }
...
// void MdPawcs::init(Mat& firstFr){
// 	name = PAWCS;
// 	frameIdx = 1;
// 	Mat sequenceROI = Mat(firstFr.size(),CV_8UC1,cv::Scalar_<uchar>(255));
// 	bgsPawcs.initialize(firstFr,sequenceROI);
// }

// void MdPawcs::destroy(){
// 	// Nothing to see here, keep scrolling.
// }

// void MdPawcs::next(Mat& nxtFr, Mat& motionMask, bool applyPostProcessing){
// 	bgsPawcs.setApplyPostProcessing(applyPostProcessing);
//     bgsPawcs.apply(nxtFr,motionMask,double(frameIdx<=100));
//     frameIdx++;
// }
