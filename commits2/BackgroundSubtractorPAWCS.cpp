...
void BackgroundSubtractorPAWCS::operator()(cv::InputArray image, cv::OutputArray fgmask, double learningRate) {
    BackgroundSubtractorPAWCS::apply(image,fgmask,learningRate);
}
